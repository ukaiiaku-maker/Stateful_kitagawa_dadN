...
from arrhenius_fracture.v9_conditioned_premark import commit_conditioned_attempt
...
class State:
    def __init__(self): self.site_status=np.zeros(3,np.uint8);self.site_node_index=np.array([0,1,1]);self.birth=[]
class Patch:
